...
# filtered_data = FilterData3d(simulation_data, .1, :pressure, .1, :omega, .1, :gamma, 1, :seed, [5,10], "y", [0,2], "z")
...
mean_scatter = plotPhase(data; plot=true, shear=false)
mat"xlim([0,200])"
## 3d energy theory development
