function process_gm_fft_freq_density(time_vector, index_particles, index_oscillating_wall, driving_amplitude, position_particles, initial_distance_from_oscillation, driving_frequency)
...
iskip = 1;
frequency_cutoff = 9;  % Define the frequency cutoff (upper limit)
position_cutoff = 60; % Distance cutoff (upper limit)
...
num_bins = 20000;  % Increase this value for more bins
