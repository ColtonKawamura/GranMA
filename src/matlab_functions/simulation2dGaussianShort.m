function simulation2dGaussianShort(K, M, Bv, w_D, N, P, W, seed)
    ...
    tau = 1/(w_D/(2*pi) )* .5; % ten cycles long, was 5, was 2
    sigma = tau  / sqrt(2*log(2)); % spread of the pulse
    t_max = 2*tau; % time when the center of the pulse occurs was 4
