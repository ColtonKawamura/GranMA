function packing_mono_2d(N, K, D, M, P_target, W_factor, seed, plotit)
...
rng(seed)
G= 1;
filename = ['in/2D_mono_N' num2str(N) '_P' num2str(P_target) '_Width' num2str(W_factor) '_Seed' num2str(seed) '.mat'];
if exist(filename)
    return
end
